...
//    Route::get("/product/{category}", 'category')->name('product');
...
Route::middleware(['auth'])->group(function () {
   ...
   Route::post('/invoice/create', [InvoiceController::class, 'create'])->name(
      'invoice.create');
...
Route::get('/product/{category}', [ClientController::class, 'products'])->name('client.product');
